  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 md:hidden">
        {/* User Button for Mobile (only show if user is logged in) */}
        {user && (
          <UserButton>
            <UserButton.MenuItems>
              <UserButton.Action
      ...
      >
        ...
        {user && (
          <button
            ...
            className="border border-gray-300 px-4 py-1 text-sm font-light rounded-full cursor-pointer transition-all hover:bg-gray-50"
          >
            Dashboard
          </button>
        )}
